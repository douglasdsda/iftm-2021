 ...
 * 
 */
@WebServiceClient(name = "ExemploServiceImplService", targetNamespace = "http://douglas.com/", wsdlLocation = "http://localhost:8080/exemplo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EXEMPLOSERVICEIMPLSERVICE_QNAME = new QName("http://douglas.com/", "ExemploServiceImplService");
    ...
    public ExemploService getExemploServiceImplPort() {
        return super.getPort(new QName("http://douglas.com/", "ExemploServiceImplPort"), ExemploService.class);
    }
    ...
    public ExemploService getExemploServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://douglas.com/", "ExemploServiceImplPort"), ExemploService.class, features);
    }
